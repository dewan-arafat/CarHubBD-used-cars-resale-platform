...
const MyBookingCard = ({ booking }) => {
    const { product_name, market_price, resale_price, product_img } = booking;
    return (
        <div className='pb-3'>
            <div className="flex w-1/2 mx-auto space-x-2 sm:space-x-4">
                <img className="flex-shrink-0 object-cover w-20 h-20 border-transparent rounded outline-none sm:w-32 sm:h-32 bg-gray-500" src={product_img} alt="Polaroid camera" />
                <div className="flex flex-col justify-between w-full pb-4">
                    <div className="flex justify-between w-full pb-2 space-x-2">
                        ...
                        <div className="text-right">
                            ...
                            <p className="text-sm line-through text-gray-400">{market_price}</p>
                        </div>
                    </div>
                    <div className="flex justify-between text-sm divide-x">
                        ...
                        <button type="button" className=" bg-gray-200 flex items-center px-2 py-1 space-x-1">
                            <Link className='p-1 font-bold'>Pay Now</Link>
                        </button>
                    </div>
                </div>
            </div>
